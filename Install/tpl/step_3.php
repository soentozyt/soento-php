	...
	<div class="main">
		...
		<table class="table1">
			...
			<tr>
				...
				<td><input type="text" class="text" value="soento" name="DB_NAME" /></td>
				<td>不存在则自动创建。</td>
			</tr>
			<tr>
				<td><font class="red">*</font>&nbsp;数据库表前缀：</td>
				<td><input type="text" class="text" value="et_" name="DB_PREFIX" /></td>
				<td>推荐使用默认。</td>
			</tr>
			<tr>
				<th>网站配置</th>
			...
			<tr>
				<td>网站名称：</td>
				<td><input type="text" class="text" value="网站系统" name="HD_webname" /></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
